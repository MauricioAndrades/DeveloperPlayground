 ...
 * 6. If a and b are arrays, proceed to the next step. If a and b are Maps, proceed to the next step. If a and b are Sets,
 *    proceed to the next step. If a and b are ArrayBuffers, return whether they have the same length and elements. If a
 *    and b are RegExps, return whether they have the same source and flags. If a and b have different valueOf or
 *    toString methods, return whether those methods return the same value for both objects.
 ...
 * @param {WeakSet<object>} visited - A set of objects that have already been visited during the comparison to prevent
 *   circular references.
